...
export namespace OSTree {
     ...
     * @since 2017.13
     */
    function checksum_file_at(dfd: number, path: string, stbuf: (any | null), objtype: ObjectType, flags: ChecksumFlags, out_checksum: string, cancellable: (Gio.Cancellable | null)): boolean;
    ...
    class Repo extends GObject.Object {
         ...
         * @param object 
         */
        static traverse_parents_get_commits(parents: ({ [key: string]: any } | GLib.HashTable<any, any>), object: GLib.Variant): string[];
         ...
         */
        gpg_sign_data(data: (GLib.Bytes | Uint8Array), old_signatures: (GLib.Bytes | null), key_id: string[], homedir: (string | null), cancellable: (Gio.Cancellable | null)): [boolean, GLib.Bytes];
         ...
         * @returns `true` on success, `false` otherwise
         */
        list_collection_refs(match_collection_id: (string | null), flags: RepoListRefsExtFlags, cancellable: (Gio.Cancellable | null)): [boolean, GLib.HashTable<CollectionRef, string>];
         ...
         */
        list_commit_objects_starting_with(start: string, cancellable: (Gio.Cancellable | null)): [boolean, GLib.HashTable<GLib.Variant, GLib.Variant>];
         ...
         * @returns `true` on success, `false` on error, and `error` will be set
         */
        list_objects(flags: RepoListObjectsFlags, cancellable: (Gio.Cancellable | null)): [boolean, GLib.HashTable<GLib.Variant, GLib.Variant>];
         ...
         * @param cancellable Cancellable
         */
        remote_list_collection_refs(remote_name: string, cancellable: (Gio.Cancellable | null)): [boolean, GLib.HashTable<CollectionRef, string>];
         ...
         * @param cancellable Cancellable
         */
        traverse_reachable_refs(depth: number, reachable: ({ [key: string]: any } | GLib.HashTable<GLib.Variant, GLib.Variant>), cancellable: (Gio.Cancellable | null)): boolean;
    ...
    class RepoFinderResult {
        ...
        // Constructors
        constructor(remote: Remote, finder: RepoFinder, priority: number, ref_to_checksum: ({ [key: string]: any } | GLib.HashTable<CollectionRef, string>), ref_to_timestamp: (GLib.HashTable<CollectionRef, (bigint | number)> | null), summary_last_modified: (bigint | number));

        static ["new"](remote: Remote, finder: RepoFinder, priority: number, ref_to_checksum: ({ [key: string]: any } | GLib.HashTable<CollectionRef, string>), ref_to_timestamp: (GLib.HashTable<CollectionRef, (bigint | number)> | null), summary_last_modified: (bigint | number)): RepoFinderResult;
