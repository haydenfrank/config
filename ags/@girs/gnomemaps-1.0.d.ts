...
export namespace GnomeMaps {
    ...
    class FileDataSource extends Shumate.DataSource {
        ...
        // Signals
        /** @signal */
        connect<K extends keyof FileDataSource.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FileDataSource.SignalSignatures[K]>): number;
        connect(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        connect_after<K extends keyof FileDataSource.SignalSignatures>(signal: K, callback: GObject.SignalCallback<this, FileDataSource.SignalSignatures[K]>): number;
        connect_after(signal: string, callback: (...args: any[]) => any): number;

        /** @signal */
        emit<K extends keyof FileDataSource.SignalSignatures>(signal: K, ...args: GObject.GjsParameters<FileDataSource.SignalSignatures[K]> extends [any, ...infer Q] ? Q : never): void;
