...
export namespace HarfBuzz {
     ...
     * @since 14.2.0
     */
    function draw_circle(dfuncs: draw_funcs_t, draw_data: (any | null), st: draw_state_t, cx: number, cy: number, r: number, stroke_width: number): void;
     ...
     * @since 14.2.0
     */
    function draw_line(dfuncs: draw_funcs_t, draw_data: (any | null), st: draw_state_t, x0: number, y0: number, w0: number, x1: number, y1: number, w1: number, cap: draw_line_cap_t): void;
     ...
     * @since 14.2.0
     */
    function draw_rectangle(dfuncs: draw_funcs_t, draw_data: (any | null), st: draw_state_t, x: number, y: number, w: number, h: number, stroke_width: number): void;
     ...
     * @since 14.2.0
     */
    function paint_push_clip_path_end(funcs: paint_funcs_t, paint_data: (any | null)): void;
     ...
     * @since 14.2.0
     */
    function paint_push_clip_path_start(funcs: paint_funcs_t, paint_data: (any | null)): [draw_funcs_t, any];
     ...
     * @since 14.2.0
     */
    function paint_push_group_for(funcs: paint_funcs_t, paint_data: (any | null), mode: paint_composite_mode_t): void;
    ...
    interface paint_push_clip_path_start_func_t {
        (funcs: paint_funcs_t, paint_data: (any | null)): draw_funcs_t;
    }
