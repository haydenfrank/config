...
export namespace PapersView {
    ...
    class AnnotationsContext extends GObject.Object implements UndoHandler {
         ...
         */
        add_annotation_sync(page_index: number, type: PapersDocument.AnnotationType, start: PapersDocument.Point, end: PapersDocument.Point, color: Gdk.RGBA, user_data: (any | null)): PapersDocument.Annotation;
